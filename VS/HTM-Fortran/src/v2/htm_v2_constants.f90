...
module htm_v2_constants
    ...
    integer(INT32),     parameter :: N_BITS_CELL    = 3
    ...
    integer(INT32),     parameter :: NEW_NUMBER_SYNAPSES        = 16

    ! TODO rename to DD_PERMANENCE_INIT
    ! Initial permanence of a new synapse
    real(REAL32),       parameter :: DD_PERMANENCE_INIT         = 0.21
    real(REAL32),       parameter :: SP_PD_PERMANENCE_INIT         = 0.21
    ...
    integer(INT32),     parameter :: MIN_DD_ACTIVATION_THRESHOLD    = 5
